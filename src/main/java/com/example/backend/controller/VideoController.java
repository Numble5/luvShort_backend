...
public class VideoController {
    ...
    public ResponseEntity<?> filteredVideoList(@RequestBody VideoFilterRequest request,@RequestParam("lastVideoIdx") Long lastVideoId, @RequestParam("size") int size, @RequestParam("userIdx") Long userIdx) {
